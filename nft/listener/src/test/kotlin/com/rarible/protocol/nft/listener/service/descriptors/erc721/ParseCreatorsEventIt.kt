...
class ParseCreatorsEventIt {

    @Test
    fun indexedWorks() {
        val tokenId = Word.apply("0xfb571f9da71d1ac33e069571bf5c67fadcff18e400000000000000000000002b")
        val data = Binary.apply(
            ""
        )
        val event = parseLog(listOf(topic, tokenId), data)
        assertEquals(
            event.tokenId(),
            BigInteger("113684458893483085791140453563089956290380401423266949679181692179405588135979")
        )
    }
