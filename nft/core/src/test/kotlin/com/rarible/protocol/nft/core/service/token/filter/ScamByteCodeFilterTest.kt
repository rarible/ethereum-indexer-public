        ...
        markers = listOf(
            ByteCodeMarker(
                payloads = listOf(
                    ByteCodeFragment(
                        offset = 0,
                        fragment = Binary.apply("0x608060405236600a57005b600036606060008073")
                    ),
                    ByteCodeFragment(
                        offset = 41,
                        fragment = Binary.apply("")
                    ),
                )
            ),
            ByteCodeMarker(
                payloads = listOf(
                    ByteCodeFragment(
                        offset = 0,
                        fragment = Binary.apply("0x6111111111111111111111111111111111111111")
                    ),
                )
            )
        )
