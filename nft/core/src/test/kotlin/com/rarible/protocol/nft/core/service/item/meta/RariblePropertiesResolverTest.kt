...
class RariblePropertiesResolverTest : BasePropertiesResolverTest() {
    ...
    fun aavegotchi() = runBlocking<Unit> {
        ...
        assertThat(properties).isEqualTo(
            ItemProperties(
                name = "#21089 - 203 kinship",
                image = "https://rarible.mypinata.cloud/ipfs/Qmf6we8fwu8KEou5s2iswb1q6bxscbNRmgw5vpmZj18evK",
                imagePreview = null,
                imageBig = null,
                animationUrl = null,
                description = "Hi fren! I'm \$#21089 - 203 kinship, a Haunt 2 Aavegotchi with a Rarity Score of 495, Devoted ($devoted) Kinship, and 12.$timestamp amWMATIC staked inside me.\n \n" +
