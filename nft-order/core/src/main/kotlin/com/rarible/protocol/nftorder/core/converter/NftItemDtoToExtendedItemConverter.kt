...
@Component
object NftItemDtoToExtendedItemConverter : Converter<NftItemDto, ExtendedItem> {

    override fun convert(nftItem: NftItemDto): ExtendedItem {
        val item = Item(
        ...
        return ExtendedItem(item, nftItem.meta)
    }
}