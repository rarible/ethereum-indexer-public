...
internal class LooksrareV1ExchangeTakerDescriptorTest {
    ...
    fun `should convert erc721 sell through GEM`() = runBlocking<Unit> {
        val transaction = mockk<Transaction> {
            every { input() } returns Binary.apply("")
        ...
        coEvery { contractService.get(any()) } returns Erc20Token(id = randomAddress(), name = "test", symbol = "1", decimals = 18)
        ...
        Assertions.assertThat(matches).hasSize(2)
        val left = matches[0]
        Assertions.assertThat(left.taker).isEqualTo(Address.apply("0x94dbb3db4102181186fd127e6f81564d1d4a20a3"))
        val right = matches[1]
        Assertions.assertThat(right.maker).isEqualTo(Address.apply("0x94dbb3db4102181186fd127e6f81564d1d4a20a3"))
    }
