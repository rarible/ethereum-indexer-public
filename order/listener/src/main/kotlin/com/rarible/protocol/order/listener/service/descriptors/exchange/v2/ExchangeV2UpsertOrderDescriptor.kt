...
class ExchangeV2UpsertOrderDescriptor(
    ...
    override fun convert(log: Log, timestamp: Long): Publisher<OnChainOrder> {
        ...
        return OnChainOrder(
            OrderVersion(
                maker = order._1(),
                make = Asset(order._2()._1().toAssetType(), EthUInt256(order._2()._2())),
                taker = order._3().takeUnless { it == Address.ZERO() },
                take = Asset(order._4()._1().toAssetType(), EthUInt256(order._4()._2)),
                makePriceUsd = null,
                takePriceUsd = null,
                makeUsd = null,
                takeUsd = null,
