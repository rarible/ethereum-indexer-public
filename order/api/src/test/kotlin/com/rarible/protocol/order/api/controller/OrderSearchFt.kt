...
class OrderSearchFt : AbstractIntegrationTest() {
    companion object {
        ...
        fun orders4All(): Stream<Arguments> = run {
            ...
            Stream.of(
                Arguments.of(orders, inactiveOrder, listOf(OrderStatusDto.INACTIVE), null, endInHour),
    ...
    fun `should find all orders with continuation`(
        ...
        Wait.waitAssert {
            ...
            do {
                val result = orderClient.getOrdersAllByStatus(sort, continuation, 2, null, null, null).awaitFirst()
    ...
    fun `should find all orders`(
        ...
        Wait.waitAssert {
            val result = orderClient.getOrdersAllByStatus(sort, null, null, null, null, null).awaitFirst()
