...
import com.rarible.protocol.order.core.service.curve.SudoSwapCurve.Companion.MIN_PRICE
...
class SudoSwapExponentialCurve : SudoSwapCurve {
    override suspend fun getBuyInfo(
        ...
        val inputValue = buySpotPrice * (deltaPowN - SudoSwapCurve.WAD) / (delta - SudoSwapCurve.WAD)
