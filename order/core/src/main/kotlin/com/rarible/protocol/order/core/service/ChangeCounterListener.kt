...
class ChangeCounterListener(
    ...
    private val batchSize = properties.batchHandle.countChangeBatchSize
    ...
    suspend fun onNewMakerNonce(
        ...
        orderRepository
            .findNotCanceledByMakerAndCounterLtThen(platform, maker, newNonce).toList()
            .asyncBatchHandle(batchSize) { hash ->
