...
internal class OrderStateValidationServiceTest {
    ...
    private lateinit var orderStateValidationService: OrderValidationService
    ...
    @MockK
    private lateinit var metrics: OrderValidationMetrics
    ...
    fun before() {
        ...
        orderStateValidationService = OrderValidationService(listOf(validator1, validator2), metrics)
    }
    ...
    fun `validate state - ok`() = runBlocking<Unit> {
        ...
        orderStateValidationService.validateState(order)
    ...
    fun `validate state - failed`() = runBlocking<Unit> {
        ...
        assertThrows<OrderDataException> { orderStateValidationService.validateState(order) }
